...
HUMAN_INTERACT_SITES = [
    "https://telegram-bot-ddhv.onrender.com/",   # replace with your sites
    "https://telegram-bot-1-58nb.onrender.com",
]
        ...
        async with async_playwright() as pw:
            ...
            while True:
                ...
                await asyncio.gather(
                    *(human_visit_and_act(browser, site) for site in HUMAN_INTERACT_SITES)
                )
