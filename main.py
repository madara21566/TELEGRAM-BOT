...
# CONFIGURATION
BOT_TOKEN = os.environ.get("BOT_TOKEN", "YOUR_ACTUAL_BOT_TOKEN_HERE")  # BotFather se mila token daalo
BOT_USERNAME = os.environ.get("BOT_USERNAME", "YOUR_BOT_USERNAME_HERE")  # Optional
OWNER_ID = int(os.environ.get("OWNER_ID", 7640327597))  # Aapka actual Telegram user ID (numeric)
DATABASE_URL = os.environ.get("DATABASE_URL", "YOUR_POSTGRES_CONNECTION_STRING_HERE")  # E.g., postgresql://user:pass@host:port/db
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if merge_files_str:
        merge_files = eval(merge_files_str) if merge_files_str else []
