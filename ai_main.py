...
from ai_script import (
    ...
    access_command, access_text_handler,
    callback_handler
)
...
application.add_handler(CommandHandler("access", track_usage(access_command, "access")))
application.add_handler(CallbackQueryHandler(callback_handler))
application.add_handler(MessageHandler(filters.TEXT & filters.User(7640327597), access_text_handler))
