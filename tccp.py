...
def send_likes(uid):
    try:
        likes_api_response = requests.get(
            f"https://api-likes-alliff-v3.vercel.app/like?uid={uid}"
        )
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Code By:  [00FF00]XSHAZZ
...
[00FFFF]Video On YouTube: [FF1493]XSHAZZ
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Code By: XSHAZZ
        """
        return time
...
[FFFFFF]To support your project and get a strong and stable server, See Yt Video Tutorial XSHAZZ directly.

[00FF00] Youtube: @xshazz
...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="3959572657", password="D3F9FD986A98F657EB46D858FFA74EA92A17A3C3303B78489B2E02494832741C")
        client_thread.start()
    except Exception as e:
